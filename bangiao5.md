...
5. ✅ **Progressive Roster** xong. **Sessions 4a+4b+4c xong**. **Share 5a xong** (2 hint: link → copy → grades). **Gradebook 5b xong** (bỏ `navigateTo`, giữ trigger tab-click). **Còn lại**: 5c set cờ onboarding khi hoàn tất Share.
