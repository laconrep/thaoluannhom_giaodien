...
-- Dán toàn bộ file này vào Supabase SQL Editor và bấm Run một lần.
...
-- ============ STORAGE ẢNH CHÈN TRONG BÀI NỘP ============
-- Bucket public: ảnh chèn trong bài viết được nhúng bằng URL công khai, link bền.
insert into storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
values (
  'submission-media',
  'submission-media',
